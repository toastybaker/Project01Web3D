...
export const ITEMS: Record<ItemId, ItemDefinition> = {
  ...
  'upgrade-coupon': { id: 'upgrade-coupon', name: '30% Upgrade Discount', icon: '/assets/ui/items/merchant/upgrade-coupon.png', category: 'utility', hotbar: false },
  ...
  'steel-pickaxe': { id: 'steel-pickaxe', name: PICKAXE_CONFIG['steel-pickaxe'].name, icon: '/assets/ui/items/gold-pickaxe.png', buyPrice: PICKAXE_CONFIG['steel-pickaxe'].price, category: 'tool' },

...
const KO: Record<string, string> = {
  ...
  'YOUR PLOT': '내 텃밭', 'YOUR FARM': '내 텃밭', 'YOUR BAY': '내 구역', 'HOME': '광장',
  ...
  'BUY: LMB': '구매: 좌클릭', 'SELL: RMB': '판매: 우클릭', '×10: SHIFT': '10개씩: Shift',
  'TIME LEFT': '남은 시간', 'MATCH TIME': '남은 시간', 'RESTOCK': '재입고', 'MARKET NEWS': '시장 뉴스',
  ...
  'PLANT': '심기', 'WATER': '물주기', 'HARVEST': '수확', 'DELIVER': '납품',
  ...
  'MINING SPEED': '채광 속도', 'STORAGE': '가방 용량', 'CAPACITY': '가방 용량', 'COST': '강화 비용',
  ...
  'RECIPE UNLOCKED!': '새 레시피!', 'ALL RECIPES LEARNED': '모든 레시피 습득 완료', 'UNLOCKED': '잠금 해제!', 'RETURNED TO PLAZA': '광장으로 이동',
  ...
  'LMB COMMON · RMB CHOOSE DESTINATION': '좌클릭 광장 · 우클릭 목적지 선택',
  ...
  'SELECT A PICKAXE': '곡괭이를 선택하세요', 'RETURNED HOME': '광장으로 이동', 'FARM LIMIT REACHED': '텃밭은 3개까지 구매할 수 있습니다',
